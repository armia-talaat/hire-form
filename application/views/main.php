				...
				<div class="col-lg-8 col-lg-offset-2">
					<form action="" enctype="multipart/form-data">
						<div class="form-group">
							...
							<div class="col-sm-7"><input required type="text" class="form-control"></div>
						</div>
						<div class="form-group">
							<label for="Dob" class="col-sm-3 col-sm-offset-1">Date Of Birth:</label>
							<div class="col-sm-2"><select required class="form-control" id="daydropdown">
							</select> 
							</div>
							<div class="col-sm-2">
							<select class="form-control" required id="monthdropdown">
							</select>
							</div> 
							<div class="col-sm-2">
							<select class="form-control" required  id="yeardropdown">
							</select> 
						...
						<div class="form-group">
							...
							<div class="col-sm-7"><select required id="education" class="form-control">
							<option value=""></option>
							</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7"><select required id="job" class="form-control">
							<option value=""></option>
							</select></div>
						</div>
						<div class="form-group">
							<label for="cv" class="col-sm-3 col-sm-offset-1">CV:</label>
							<div class="col-sm-7"><input required type="file" style="color: white;" accept=".pdf"></div>
						</div>
						<div class="form-group">
